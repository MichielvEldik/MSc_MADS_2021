...
# __3. Remove numbers, punctuation, doubles__
``` {r }
# For message
geo_sao_paolo_df  <- geo_sao_paolo_df %>%
  mutate(
...
```
In conclusion, we need something else because the dictionary method is going to 
be too unreliable.

## __9.3. Solution: Standardization through character encoding__
...
## __10.2. Most frequent words__


``` {r}
text_df <- tibble(line = 1:41638, 
...
## __10.3. Unique words__

How many? 

## __10.4. Formulating stop words list__
...
## __10.5. Filtering out stop words__
