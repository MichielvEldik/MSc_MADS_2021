...
## __10.3. Creating a custom stopwords dictionary__
__DISCLAIMER:__ It's not really a dictionary as it doesn't have unique key-value pairs.
...
Filter out words that have more than 2 consecutive characters.
```{r }
new_text_df %>%
